...
class Telemetry(Packet):
   fields_desc = [ BitField("qlen", 0, 16),
...
def handle_pkt(pkt):
    ...
    # print "Queue Info:"
    # print "enq_depth", telemetry.qlen
    #print "deq_depth", telemetry.deq_depth
    # print
    print time.time() % 3600, telemetry.qlen

bind_layers(Ether, Telemetry, type=0x8777)
...
def main():
    ...
    sniff(filter="ether proto 0x8777", iface = iface,
